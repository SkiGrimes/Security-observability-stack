...
USERS = {'alice': 'password123', 'bob': 'qwerty', 'carol': 'letmein'}
...
def index():
    ...
    return jsonify({'service': 'Hotline Capital Lending API', 'status': 'operational', 'version': '1.0.0'})
...
def quote():
    ...
    return jsonify({'loan_amount': random.randint(5000, 50000), 'apr': round(random.uniform(5.0, 18.0), 2), 'term_months': 36})
